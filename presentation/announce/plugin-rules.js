    ...
    return (
      ...
      >
        ...
        <List style={[styles.littleSpacePlease, styles.extraSmallText]}>
          ...
          <ListItem textColor="primary" style={styles.listItems}><Text textColor="red" style={[styles.extraSmallText, { display: "inline", marginRight: "5px" }]}>has-accessibility-props:</Text> Enforce all {"<"}Touchable\*> components have accessibilityTraits and accessibilityComponentType props set</ListItem>
